/**
 * QuantumShield — Electron Main Process v2.1
 * Cross-platform desktop application (Windows / Linux / macOS)
 * Features: auto-start server, tray icon, native menus, folder scanning, OS-specific UX, auto-updater
 */
  ...
  const template = [
    ...
    },
    {
      ...
      submenu: [
        ...
        { label: '下载中心', accelerator: 'Alt+6', click: () => mainWindow.webContents.executeJavaScript("document.dispatchEvent(new KeyboardEvent('keydown', {altKey:true, key:'6'}))") },
      ],
    },
    {
      label: '帮助',
      submenu: [
        ...
        },
        {
          ...
          click: () => {
            dialog.showMessageBox(mainWindow, {
              ...
              message: `QuantumShield v${APP_VERSION}`,
        ...
        },
        {
          ...
          click: () => {
            mainWindow?.show();
            mainWindow?.webContents.executeJavaScript("document.dispatchEvent(new KeyboardEvent('keydown', {altKey:true, key:'6'}))");
          },
        },
      ],
    },
